...
\newcommand{\fillthis}[1]{\textcolor{blue}{#1}}
\newcommand{\tochange}[1]{\textcolor{magenta}{#1}}
\newcommand{\checkthis}[1]{\textcolor{blue}{#1~\bfseries *\footnote{Check this}*}}
\newcommand{\ednote}[1]{\textcolor{blue}{~\bfseries *\footnote{#1}*}}
\newcommand{\needrefs}{\textcolor{blue}{(INSERT REFS)}}
\newcommand{\needrefabout}[1]{\textcolor{blue}{(REFS~\bfseries *\footnote{#1}*)}}
\newcommand{\toadd}[1]{[TO ADD: \textcolor{blue}{#1}]}
